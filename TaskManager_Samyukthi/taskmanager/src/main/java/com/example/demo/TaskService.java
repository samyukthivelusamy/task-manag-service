...
public class TaskService {
	...
	public void addTask(Task task){
	    ...
	    String sql = "INSERT INTO task(parent_id,task,start_date,end_date,priority) "
	    		+ " VALUES("+i+",'"+task.getTask()+"','"+task.getStartDate()+"','"+task.getEndDate()+"','"+task.getPriority()+"')";
	...
	public List<Task> getAllTasks() {
		String query = "select t.task_id,t.task,t.priority,t.start_date,t.end_date, pt.parent_task,pt.parent_id as parentTaskId from task t left join parent_task pt on t.parent_id=pt.parent_id ";
